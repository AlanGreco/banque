				...
				<div class="cfg-element-set" id="cfg-element-8-9-set">
					<div class="cfg-element-content">
						<span class="cfg-title " name="cfg-element-8-9"
							id="cfg-element-8-9">Connection</span>
					</div>
				</div>
			</div>
			...
			<form action="login" method="post">
				...
				<div class="cfg-element-container">
					...
					<label class="cfg-label" id="cfg-element-8-7-label"><span
						class="cfg-label-value">Mot de passe</span></label>

					<div class="cfg-element-set" id="cfg-element-8-7-set">
						<div class="cfg-element-content">
							<input type="text" class="cfg-type-text cfg-form-value "
								name="motDePasseClient" id="cfg-element-8-7" />
						</div>
					</div>
				...
				<div class="cfg-element-container">
					...
					<div class="cfg-element-set" id="cfg-element-8-5-set">
						<div class="cfg-element-content">
							<input type="submit" class="cfg-submit " name="submitLogin"
