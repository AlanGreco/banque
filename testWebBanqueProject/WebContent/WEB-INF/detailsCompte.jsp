...
<body>
	...
	<div class="container">
		...
		<table class="table" style="text-align: center;">
			...
			<c:if
				test="${compteSelectionne.class.name == 'entities.CompteEpargne'}">
				<tr style="height: 20px;">
		...
		<div class="panel panel-default">
			...
			<td>Montant</td>
				...
				<tr>
				<td>
				<c:set var="dateMouvement" target="java.util.Date" value="${mouvement.date}" />
				<fmt:formatDate value="${dateMouvement}" type="both" dateStyle="short"/>
				</td>
